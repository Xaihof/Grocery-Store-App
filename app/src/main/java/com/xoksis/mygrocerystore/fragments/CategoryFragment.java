...
import com.xoksis.mygrocerystore.adapters.NavCategoryAdapter;
import com.xoksis.mygrocerystore.databinding.FragmentCategoryBinding;
...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Popular items
        categoryBinding.catRec.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.VERTICAL, false));
        categoryModelList = new ArrayList<>();
        navCategoryAdapter = new NavCategoryAdapter(getActivity(), categoryModelList);
        categoryBinding.catRec.setAdapter(navCategoryAdapter);
